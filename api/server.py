...
def start_training(job_id):
    ...
    try:
        # Define the train_thread function
        def train_thread():
            # Emit training start event
            socketio.emit('training_started', {'job_id': job_id}, room=job_id)
